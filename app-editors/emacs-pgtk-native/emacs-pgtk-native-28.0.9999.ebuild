...
EMACS_SUFFIX="emacs-pgtk-native"
...
src_compile() {
    AOT_OPTS=""
    if use aot; then
        AOT_OPTS="NATIVE_FULL_AOT=1"
    fi
	emake RUN_TEMACS="SANDBOX_ON=0 LD_PRELOAD= env ./temacs" ${AOT_OPTS}
}
